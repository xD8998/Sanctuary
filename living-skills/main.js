...
const tips = [
  'PRO TIP: Game I made for English class, now integrated to Living Skills.',
...
function resize() {
  ...
  initFaces({ width: bg.width, height: bg.height, dpr });
}
...
function frame(t) {
  ...
  renderPlasma(t);
  updateAndDrawFaces(bgCtx, { width: bg.width, height: bg.height, dpr }, dt);
  drawViz();
  last = t;
...
import { initFaces, updateAndDrawFaces } from './faces.js';